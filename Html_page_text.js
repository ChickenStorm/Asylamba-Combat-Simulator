...
htmlPage += " <div style='display: inline-block; position:absolute;' id='resultGeneral'> <div id='result' style=' display: inline-block; position:relative; '></div> <br> <div id='moreDetaileResult' style=' display: inline-block; position:relative; '></div> </div> <div id = 'di1' style ='display: inline-block; position:absolute;'> Nombre d'it&eacute;rations <input id='i1' style='position:relative;' type='number' > <br>  (un grand nombre augmente la pr&eacute;cision)</div>"
